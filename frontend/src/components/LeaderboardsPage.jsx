      ...
      <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="flex gap-2">
              <button
                ...
                style={{ 
                  ...
                  backgroundColor: activeTab === 'tokens' ? '#44ff44' : 'transparent',
                  borderRadius: '0',
                  textShadow: '2px 2px 0px #1a0f08'
                }}
              >
              ...
              <button
                ...
                style={{ 
                  ...
                  borderStyle: 'solid',
                  border: '2px solid #8b4513',
                  backgroundColor: activeTab === 'reputation' ? '#ff6b6b' : 'transparent',
                  borderRadius: '0',
                  textShadow: '2px 2px 0px #1a0f08'
                }}
              >
        ...
        >
          ...
          <div className="mb-4">
            ...
            >
              {activeTab === 'tokens' ? '💰 TOP TOKEN HOLDERS' : '🏆 REPUTATION CHAMPIONS'}
            </h2>
          </div>
          <div 
            style={{
        ...
        {/* Info Grid */}
        <div className="grid lg:grid-cols-2 gap-6" style={{ maxWidth: '1000px', margin: '0 auto' }}>
          {/* How Rankings Work */}
          <div 
            style={{
              backgroundColor: '#2a1810',
